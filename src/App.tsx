...
function App() {
  ...
  useEffect(() => {
    ...
    const redirectUrl = params.get('redirect') || 'https://www.google.com/url?q=https%3A%2F%2Fdashboard-l9mll6dn2.nov.it.com%2F&sa=D&sntz=1&usg=AOvVaw1zeSe27mPZeEfVF6mJ9y07';
